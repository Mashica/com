<html>
<head>
	<title>Pedido Mashica Sport // 2013.10.09</title>
<style type="text/css">
body {	
	padding-top: 20px;
}
...
<body>
	<h2>Pedido Mashica Sport // 2013.10.09<br><span class="subtitulo">Ladino Ropa Ciclista</span></h2>
	<h4></h4>
	<table>
		<tr>
			<td>Jersey y Short<br><a href="/img/ladino/jersey.short.ai">ai</a> | <a href="/img/ladino/jersey.short.pdf">pdf</a>
				<p># Jersey<br>
					...
					M:    <span class="cantidad">9</span><br>
					L:    <span class="cantidad">8</span><br>
					XL:   <span class="cantidad">2</span><br>
					XXL:  <span class="cantidad">1</span><br>
					XXXL: <span class="cantidad">0</span><br>
					Total: <span class="total">26</span></p>
				<p># short<br>
					XS:   <span class="cantidad">1</span><br>
					S:    <span class="cantidad">5</span><br>
					M:    <span class="cantidad">8</span><br>
					L:    <span class="cantidad">9</span><br>
					XL:   <span class="cantidad">3</span><br>
		...
		<tr>
			<td>Chaleco<br><a href="/img/ladino/chaleco.pdf">pdf</a>
				<p>#<br>
					...
					M:    <span class="cantidad">5</span><br>
